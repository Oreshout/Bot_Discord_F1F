...
from qualif import (
    pronos_qualif_logic,
    visualisation_pronos_qualif_logic,
    modify_qualif_logic,
)
...
@tree.command(
    name="help", description="Gives you all the commands you can use with this bot"
)
...
@app_commands.describe(
    ...
    meilleur_tour="Meilleur Tour",
)
async def prono_race(
...
@tree.command(
    name="pronos_qualifs", description="Pronostiques Qualification de Formule 1"
)
@app_commands.describe(
    premier="Le premier", deuxieme="Le deuxième", troisieme="Le troisième"
)
async def pronostique_qualification(
...
@tree.command(
    name="visualisation_pronos_course", description="Voir mon pronostique de course"
)
...
@tree.command(
    name="visualisation_pronos_qualif", description="Voir mon pronostique de qualif"
)
...
@tree.command(
    name="modify_course", description="Modifie ton pronostique pour la course"
)
@app_commands.describe(
    premier="Le premier",
    deuxieme="Le deuxième",
...
@tree.command(
    name="modify_qualif", description="Modifie ton pronostique pour la qualification"
)
@app_commands.describe(
    premier="Le premier", deuxieme="Le deuxième", troisieme="Le troisième"
)
async def modifier_qualif(
    interaction: discord.Interaction, premier: str, deuxieme: str, troisieme: str
):
...
async def classement(interaction: discord.Interaction):
    ...
    if resultats is None or pronostics is None:
        await interaction.followup.send(
            "Erreur : Fichier(s) manquant(s)", ephemeral=True
        )
        return
