...
async def help(interaction: discord.Interaction):
    ...
    embed.add_field(
        name="/pronos_qualifs",
        value="Enregistre ton pronostique pour les qualifications",
        inline=False,
    )
    embed.add_field(
        name="/pronos_course",
    ...
    embed.add_field(
        name="/visualisation_pronos_course",
        value="Te montre ton pronostique actuel de course",
        inline=False,
    )
    embed.add_field(
        name="/visualisation_pronos_qualif",
        value="Te montre ton pronostique actuel de qualif",
        inline=False,
    )
    embed.add_field(
        name="/modify_course",
        value="Modifie ton pronostique pour la course",
        inline=False,
    )
    embed.add_field(
        name="/modify_qualif",
        value="Modifie ton pronostique pour la qualif",
        inline=False,
    )
